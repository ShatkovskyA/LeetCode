...
/**
 * Класс _53_Maximum_Subarray_ - максимальный подмассив.
 *
...
Функция max также O(1). Следовательно, временная сложность равна O(n), где n — количество элементов во входном списке nums.
 */
