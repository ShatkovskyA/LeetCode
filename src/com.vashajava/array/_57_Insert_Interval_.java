...
/*
Общая временная сложность этого подхода определяется операцией сортировки, которая определяет O(n log n)количество nинтервалов, включая новый интервал.
